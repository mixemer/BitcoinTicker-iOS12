...
class ViewController: UIViewController, UIPickerViewDataSource, UIPickerViewDelegate {
    ...
    var indexOfCurrencyAndSymbol = 0
    var finalURL = ""
    ...
    // This deleggate method displays the number of column
...
//    /***************************************************************/
    func updateBTCData(json: JSON) {
        if let bitcoinPrice = json["ask"].double {
            bitcoinPriceLabel.text = "\(currencySymbols[indexOfCurrencyAndSymbol])\(bitcoinPrice)"
        }
        else {
            bitcoinPriceLabel.text = "Price is unavailable"
        }
